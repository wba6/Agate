...
public:
    ...
    void Attach() override
    {
        ...
        model = new Agate::ModelLoader(std::filesystem::path("Shaders/sponza/sponza.obj").generic_string());
    }
    ...
    void OnRender() override
    {
        ...
        trans_model = glm::scale(trans_model, glm::vec3(1.0f, 1.0f, 1.0f)*0.2f);    // it's a bit too big for our scene, so scale it down
